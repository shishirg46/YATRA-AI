...
const baseHazard = { floodIndex: 0, landslideIndex: 0, earthquakeIndex: 0, heatIndex: 0, airQuality: 0 };
...
const hazards = { floodIndex: 0.8, landslideIndex: 0, earthquakeIndex: 0, heatIndex: 0, airQuality: 0 };
